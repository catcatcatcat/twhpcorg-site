        ...
        <div className="container-custom relative z-10">
          <div className="text-center">
            ...
            >
              ...
              <span>{isEnglish ? 'Course Features' : '課程特色'}</span>
            </motion.div>
            <motion.h1 
            ...
            >
              {isEnglish ? 'Course Features' : '課程特色'}
            </motion.h1>
            <motion.div 
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-4 text-dark-blue">
                {isEnglish ? 'What Makes Our Courses Unique' : '我們課程的獨特之處'}
              </h2>
              <p className="text-lg text-gray-600">
                {isEnglish 
                  ? 'Project-Based Learning approach with hands-on experience' 
                  : '以專案為基礎的學習方法，提供實作經驗'}
              </p>
            </div>
